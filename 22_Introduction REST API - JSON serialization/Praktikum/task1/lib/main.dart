...
import 'package:task1/models/book_model.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'REST API List Book'),
    );
  }
}
                          ...
                          onPressed: () {
                            ...
                            Dio()
                              ...
                              if (response_detail["status_code"] == 201) {
                                ...
                                books.add(
                                    BookModel.fromJson(response_data["data"]));
                                setState(() {});
                              } else {
...
// import 'package:dio/dio.dart';
// import 'package:task1/models/book_model.dart';
// import 'package:task1/utils/fetch.dart';
