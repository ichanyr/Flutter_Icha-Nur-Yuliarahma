...
// menambahkan varible dueDate dan currentDate
  ...
  Color _currentColor = Colors.yellow; // mengambil data dari colorpicker
    ...
    return Column(children: [
            ...
            ElevatedButton(
              onPressed: () {
                if (formKey.currentState!.validate()) {
                  ...
                  print(contactManager.contactsModel);
                  contactManager.addContact(ContactModel(
                    name: nameController.text,
                    phoneNumber: phoneNumberController.text,
                    date: _dueDate.toString(),
                    color: _currentColor,
                    fileName: _selectedFilePath.toString(),
                  ));

                  print(contactManager.contactsModel);
                  for (var i = 0;
                      i < contactManager.contactsModel.length;
                      i++) {
                    print(contactManager.contactsModel[i].name);
                    print(contactManager.contactsModel[i].phoneNumber);
                    print(contactManager.contactsModel[i].date);
                    print(contactManager.contactsModel[i].color);
                    print(contactManager.contactsModel[i].fileName);
                  }
      ...
      Consumer<ContactManager>(
        builder: (context, value, child) {
          if (value.contactsModel.isNotEmpty) {
            // for (var i = 0; i < dataList.length; i++)
            // return Column(children: [
            ...
            return ListView.builder(
                shrinkWrap: true,
                itemCount: value.contactsModel.length,
                  ...
                  return Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        CircleAvatar(
                          child: Text(
                              value.contactsModel[index].name.substring(0, 1)),
                        ),
                        SizedBox(
                          width: 12,
                        ),
                        Column(
                          ...
                          children: [
                            Text(
                              value.contactsModel[index].name.toString(),
                              style: TextStyle(
                            ...
                            Text(
                              value.contactsModel[index].phoneNumber.toString(),
                              style: TextStyle(
                            ...
                            // Tampilkan tanggal
                            Text(
                              'Date: ${DateFormat('dd-MM-yyyy').format(DateTime.parse(value.contactsModel[index].date.toString()))}',
                              style: TextStyle(
                                  fontSize: 12, fontWeight: FontWeight.w400),
                            ),
                            SizedBox(
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                    ...
                                    width:
                                        10, // Atur lebar container keinginan Anda
                                    decoration: BoxDecoration(
                                      color: value.contactsModel[index].color,
                        ...
                        IconButton(
                            onPressed: () {
                              ...
                              //   index,
                              //   value.contactsModel[index].name.toString(),
                              //   value.contactsModel[index].phoneNumber
                              //       .toString(),
                              //   value.contactsModel[index].date.toString(),
                              //   value.contactsModel[index].color,
                              //   value.contactsModel[index].fileName.toString(),
                              // );
                              showDialog(
                                  context: context,
                                  builder: (context) {
                                    ...
                                    phoneNumberController.text = value
                                        .contactsModel[index].phoneNumber
                                        .toString();
                                      ...
                                      content: SingleChildScrollView(
                                        child: Column(
                                          children: [
                                            ...
                                            buildDatePickerUpdate(
                                                context,
                                                value.contactsModel[index].date
                                                    .toString()),
                                            buildColorPickerUpdate(
                                                context,
                                                value.contactsModel[index]
                                                    .color),
                                            buildFilePicker(context),
                                          ],
                                        ),
  ...
  Widget buildDatePickerUpdate(BuildContext context, String date) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
                    ...
                    return AlertDialog(
                      ...
                      content: BlockPicker(
                          ...
                          onColorChanged: (color) {
                            ...
                            print("ini adalah warna : $_currentColor");
                          }),
                      actions: [
                        TextButton(
                            onPressed: () {
  ...
  Widget buildColorPickerUpdate(BuildContext context, Color color) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Color'),
              ...
              showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: BlockPicker(
                          pickerColor: color,
                          onColorChanged: (_colorValue) {
                            setState(() {
                              _currentColor = _colorValue;
                            });
                            print("ini adalah warna : $_currentColor");
                          }),
                      actions: [
        ...
        ElevatedButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => GalleryList()));
            },
